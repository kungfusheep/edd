...
func (c *ColoredMatrixCanvas) GetColorAt(p diagram.Point) string {
...
func (c *ColoredMatrixCanvas) SetWithColor(p diagram.Point, char rune, color string) error {
	// Set the character
...
func (c *ColoredMatrixCanvas) SetWithStyle(p diagram.Point, char rune, style string) error {
	// Set the character
	if err := c.MatrixCanvas.Set(p, char); err != nil {
		return err
	}
...
func (c *ColoredMatrixCanvas) SetWithColorAndStyle(p diagram.Point, char rune, color string, style string) error {
	// Set the character
	if err := c.MatrixCanvas.Set(p, char); err != nil {
		return err
	}
...
func (t *TrackingCanvas) Set(p diagram.Point, char rune) error {
	if t.color != "" {
...
func (t *TrackingCanvas) Get(p diagram.Point) rune {
