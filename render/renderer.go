...
type Renderer struct {
	...
	capabilities  TerminalCapabilities // Cached to avoid repeated detection
...
func (r *Renderer) Render(d *diagram.Diagram) (string, error) {
	// Use the registry to get the appropriate renderer
	renderer, err := r.registry.GetRenderer(d.GetType())
	if err != nil {
