...
func showHelp() {
	...
	fmt.Println("  O     - Reorder participants (sequence diagrams)")
	fmt.Println("  v     - Toggle activation (sequence diagrams)")
	fmt.Println("  V     - Delete activations (sequence diagrams)")
	fmt.Println("  u     - Undo")
