...
// Consumers don't need to know about virtual vs physical render.
type ObstacleManager interface {
	...
	GetObstacleFunc(nodes []diagram.Node, activeConnID int) func(diagram.Point) bool
	
	// GetObstacleFuncForConnection returns obstacles for a specific connection
	GetObstacleFuncForConnection(nodes []diagram.Node, conn diagram.Connection) func(diagram.Point) bool
...
func (m *unifiedObstacleManager) GetObstacleFunc(nodes []diagram.Node, activeConnID int) func(diagram.Point) bool {
...
func (m *unifiedObstacleManager) isPortObstacle(p diagram.Point, nodes []diagram.Node, activeConnID int) bool {
	if m.portManager == nil {
		return false
	}
...
func (m *unifiedObstacleManager) isInPortCorridor(p diagram.Point, port Port, node diagram.Node) bool {
...
func (m *unifiedObstacleManager) GetObstacleFuncForConnection(nodes []diagram.Node, conn diagram.Connection) func(diagram.Point) bool {
